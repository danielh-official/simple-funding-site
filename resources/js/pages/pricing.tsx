                    ...
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            ...
                            <p className="mb-4 text-base text-[#706f6c] dark:text-[#A1A09A]">
                                Simple Funding offers transparent, affordable
                                pricing for everyone. No hidden fees—just
                                straightforward plans to help you reach your
                                fundraising goals.
                            </p>
                            <ul className="mb-6 flex flex-col gap-2">
                                ...
                                <li className="flex items-center gap-2">
                                    <span className="inline-block h-3 w-3 rounded-full bg-[#f53003] dark:bg-[#FF4433]" />
                                    <span>
                                        CSV export and supporter updates
                                        included
                                    </span>
                                </li>
                            </ul>
